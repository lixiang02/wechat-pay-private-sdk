...
class EntrustBase extends Base_1.default {
    ...
    queryContract(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const extra = yield this.createFetchOptions(QUERY_CONTRACT_BASE);
    ...
    entrustBase(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signData = utils_1.sign("HMAC-SHA256" /* "HMAC-SHA256" */, data, key);
            data.sign = signData;
...
//# sourceMappingURL=EntrustBase.js.map